...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-2xs">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Paket Pekerjaan</h2>
    ...
    <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <div id="locationInfo" class="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg hidden">
                <h4 class="font-medium text-blue-900 mb-1">Lokasi Terpilih:</h4>
                <p id="coordinateText" class="text-xs text-blue-600 mt-1"></p>
            </div>
            </div>
