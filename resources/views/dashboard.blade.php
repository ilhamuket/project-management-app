...
@section('content')
  ...
  <div class="grid lg:grid-cols-2 gap-4 sm:gap-6">
    ...
    <div class="p-4 md:p-5 min-h-102.5 flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      ...
      <div class="flex flex-wrap justify-between items-center gap-2">
        ...
        <div>
          <select id="yearSelector" class="py-2 px-3 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
  ...
  <div class="p-4 md:p-5 bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      ...
      <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
        <thead class="bg-gray-50 dark:bg-neutral-800">
          <tr>
            ...
            <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Paket Pekerjaan</th>
            <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Kontraktor</th>
            <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Nilai Kontrak</th>
            <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Progress</th>
            <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Alamat</th>
          </tr>
        </thead>
          ...
          @forelse($topRunningProjects as $index => $project)
            <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700">
              ...
              <td class="px-6 py-4 text-sm text-gray-800 dark:text-neutral-200">
                <div class="max-w-xs">
                  <p class="font-medium">{{ $project->paket_pekerjaan }}</p>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
