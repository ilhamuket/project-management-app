<!-- Breadcrumb -->
<div class="sticky top-16 inset-x-0 z-20 bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 lg:hidden dark:bg-neutral-800 dark:border-neutral-700">
  <div class="flex items-center py-3">
    
    <!-- Breadcrumb Navigation -->
    <nav aria-label="Breadcrumb" class="flex items-center space-x-1 text-sm text-gray-500 dark:text-neutral-400">
      <a href="{{ route('dashboard') }}" class="flex items-center hover:text-gray-700 dark:hover:text-neutral-200 transition-colors">
      ...
      @if(!request()->routeIs('dashboard'))
        <svg class="w-4 h-4 text-gray-400 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
